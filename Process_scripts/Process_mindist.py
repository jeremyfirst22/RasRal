...
fig.text(0.03,0.5, r"Min distance to water ($\rm{\AA}$)", ha='center', va='center',rotation='vertical') 

avgAccum, rateAccum = [], [] 
for mol in molecList : 
    molec = 'RasRalC18CNC_Q61%s'%mol
    name = "Q61%s"%mol 
    datafile = '%s/Analysis/boltzmann/mindist.weighted.out'%molec
...
fig.savefig('figures/rate_v_mindist.png',format='png') 
plt.close() 
