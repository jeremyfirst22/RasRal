...
fig.text(0.03,0.5, r"Min distance: Q61 heavy atom - GTP PG ($\rm{\AA}$)", ha='center', va='center',rotation='vertical') 

avgAccum, rateAccum = [], [] 
for mol in molecList : 
    molec = 'RasRalC18CNC_Q61%s'%mol
    name = "Q61%s"%mol 
    datafile = '%s/Analysis/boltzmann/distQ69.weighted.out'%molec
...
fig.savefig('figures/rate_v_distQ61.png',format='png') 
plt.close() 
