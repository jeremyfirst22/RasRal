...
exp_data = 'Exp_data/transforming_efficiency.txt'
...
fig.text(0.03,0.5, r"Transform", ha='center', va='center',rotation='vertical') 
...
for mol in molecList : 
    ...
    try : 
        ...
        rate, error = nameToExpRate[name] ,0
    except KeyError : 
        print "No key found %s"%mol
        continue 
...
fig.savefig('figures/peak_v_transform.png',format='png') 
plt.close() 
